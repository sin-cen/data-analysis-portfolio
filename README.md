...
###  분석 목적
- 단순 소비 비중 비교를 넘어,
  2022년 대비 2025년 소비 구조 변화 패턴을 유형화하기 위함
...
###  분석 방법
- 업종별 소비 비중 및 변화량을 기준으로 K-Means 군집 분석 수행

###  군집 결과 해석
- Cluster 0 (감소형 소비):  
  소비 비중은 크지만, 시간이 지남에 따라 비중이 감소하는 업종군
- Cluster 1 (성장형 소비):  
  소비 비중이 증가하며 소비 구조 변화를 주도하는 업종군
- Cluster 2 (안정·정체형 소비):  
  소비 비중과 변화가 모두 제한적인 안정적 업종군

###  시사점
- 성장형 소비 군집은 중장기 소비 트렌드 분석 및 정책·마케팅 타겟으로 활용 가능
- 감소형 소비 군집은 구조적 변화 여부를 지속적으로 관찰할 필요가 있음
